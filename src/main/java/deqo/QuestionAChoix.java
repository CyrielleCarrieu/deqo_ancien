...
public interface QuestionAChoix {
     ...
     * Exemple :
     * Pour l'énoncé : "L'année 2016 est une année bissextile. 1.
     * Vrai, 2. Faux"
     * L'année 2016 étant bissextile, le score donné par l'indice 1 est
     * de 100 et le score de l'indice 2 est 0
